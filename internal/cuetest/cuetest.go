...
const (
	envLong = "CUERIOUS_LONG"

	envUpdate = "CUERIOUS_UPDATE"
	...
	// longer being skipped.  e.g.  CUERIOUS_NON_ISSUES=. will cause all issue
	// tracker conditions (e.g. [golang.org/issues/1234]) to be considered
	// non-issues.
	envNonIssues = "CUERIOUS_NON_ISSUES"

	envFormatTxtar = "CUERIOUS_FORMAT_TXTAR"
)
...
// It is controlled by setting CUERIOUS_LONG to a non-empty string like "true".
...
// It is controlled by setting CUERIOUS_UPDATE to a non-empty string like "true".
...
// It is controlled by setting CUERIOUS_FORMAT_TXTAR to a non-empty string like "true".
...
//
// [golang.org/issue/N] - evaluates to true unless CUERIOUS_NON_ISSUES
// is set to a regexp that matches the condition, i.e. golang.org/issue/N
// in this case
//
// [cuelang.org/issue/N] - evaluates to true unless CUERIOUS_NON_ISSUES
...
// by s is deemed to be a non-issue by CUERIOUS_NON_ISSUES.
...
// CUERIOUS_NON_ISSUES for a match, in which case nonIssue is true (a value of true
